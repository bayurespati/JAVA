...
public class ex_9_ch_8_game_tic_tac_toe_game {
    ...
    public static boolean isWining(char[][] boardGame){
        return  (checkBoardGameHorizontal(boardGame) || checkBoardGameVertical(boardGame) || checkBoardGameDiagonalDownRight(boardGame) || checkBoardGameDiagonalDownLeft(boardGame));
    }

    public static boolean checkBoardGameHorizontal(char[][] boardGame){
    ...
    public static boolean checkBoardGameVertical(char[][] boardGame){
        int countX = 0,countO = 0;
        for(int row = 0; row < boardGame.length; row++){
            for(int col = 0; col < boardGame.length; col++){
    ...
    public static boolean checkBoardGameDiagonalDownRight(char[][] boardGame){
        int countX = 0,countO = 0;
        for(int row = 0; row < boardGame.length; row++){
    ...
    public static boolean checkBoardGameDiagonalDownLeft(char[][] boardGame){
        int countX = 0, countO = 0;
